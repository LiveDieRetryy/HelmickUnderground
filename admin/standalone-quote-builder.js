            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="width: 50%; vertical-align: top; padding-left: 0.5rem;">
                        ...
                        <p style="margin: 0; line-height: 1.3; color: #000; font-weight: 600; font-size: 0.85rem;">${customerName}</p>
                        ${customerEmail ? `<p style="margin: 0.1rem 0; line-height: 1.3; color: #505050; font-size: 0.8rem;">${customerEmail}</p>` : ''}
                        ${customerPhone ? `<p style="margin: 0.1rem 0; line-height: 1.3; color: #505050; font-size: 0.8rem;">${customerPhone}</p>` : ''}
                    </td>
                </tr>
            </table>
        </div>
